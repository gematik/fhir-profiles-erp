Profile: GEM_ERP_PR_Bundle_Practitioner_Documentation
Parent: Bundle
...
* insert Profile(GEM_ERP_PR_Bundle_Practitioner_Documentation)
* id 1..1
* identifier 1..1 MS
...
InstanceOf: GEM_ERP_PR_Bundle_Practitioner_Documentation
