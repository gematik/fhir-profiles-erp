...
and GEM_ERP_EX_REDEEMABLE_EU_EPrescription named redeemable-eu-eprescription 0..1
//and GEM_ERP_EX_SHOULD_REDEEM_EU_EPrescription named should-redeem-eu-eprescription 0..1
