...
* identifier[AccessCode].system = "https://gematik.de/fhir/erp/NamingSystem/AccessCode" (exactly)
* identifier[AccessCode].value 1..
* identifier[Secret] ^short = "Secret"
* identifier[Secret].system 1..
* identifier[Secret].system = "https://gematik.de/fhir/erp/NamingSystem/Secret" (exactly)
...
* input[ePrescription].type.coding.system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType" (exactly)
* input[ePrescription].type.coding.system ^code.system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType"
...
* input[patientReceipt].type.coding.system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType" (exactly)
* input[patientReceipt].type.coding.system ^code.system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType"
...
* output[receipt].type.coding.system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType" (exactly)
