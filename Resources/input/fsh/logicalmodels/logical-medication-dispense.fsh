  ...
  * medicationArzneimittel 0..1 Meta "Medikation als contained Element"
    ...
    * form 0..1 CodeableConcept "Darreichungsform"
      ...
      * kbvDarreichungsform 0..1 Coding "kbvDarreichungsform"
        * code 1..1 string "kbvDarreichungsform-Code"
