Instance: api-erp-example-01-Parameters-ExampleCloseInputParameters
InstanceOf: Parameters
Usage: #example
* meta.profile = "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_CloseOperation_Input|1.4"
