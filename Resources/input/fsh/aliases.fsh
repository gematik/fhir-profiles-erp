...
Alias: $GEM_ERP_CS_AvailabilityStatus = https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_AvailabilityStatus
Alias: $GEM_ERP_CS_FlowType = https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_FlowType
