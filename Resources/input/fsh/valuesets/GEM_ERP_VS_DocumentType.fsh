...
* ^url = "https://gematik.de/fhir/erp/ValueSet/DocumentType"
* ^version = "1.2"
* ^status = #draft
* ^experimental = false
...
* ^expansion.total = 3
* ^expansion.contains[0].system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType"
* ^expansion.contains[=].code = #1
* ^expansion.contains[=].display = "Health Care Provider Prescription"
* ^expansion.contains[+].system = "https://gematik.de/fhir/erp/CodeSystem/DocumentType"
