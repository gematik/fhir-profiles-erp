ValueSet: GEM_ERP_VS_ConsentType
...
//* ^expansion.total = 1
//* ^expansion.contains.system = "https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_ConsentType"
//* ^expansion.contains.code = #CHARGCONS
//* ^expansion.contains.display = "Consent for saving electronic charge item"
* include codes from system GEM_ERP_CS_ConsentType