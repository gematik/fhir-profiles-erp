...
* ^expansion.total = 6
* ^expansion.contains[0].system = ":/https/gematik.de/fhir/erp/CodeSystem/AvailabilityStatus"
* ^expansion.contains[=].code = #10
* ^expansion.contains[=].display = "sofort verfügbar"
* ^expansion.contains[+].system = "https://gematik.de/fhir/erp/CodeSystem/AvailabilityStatus"
...
* include codes from system AvailabilityStatusCS