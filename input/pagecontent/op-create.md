...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Task erzeugen - Rollenprüfung">
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Task erzeugen - Schemavalidierung Rezept anlegen">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Parametrierung Task für Workflow-Typ">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Ergänzung Performer-Typ für Einlöseinstitutstyp">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Task erzeugen - Generierung Rezept-ID">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Task erzeugen - Task-ID=Rezept-ID">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Task erzeugen - Generierung AccessCode">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
...
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - Status draft">
  <meta lockversion="false"/>
  <actor name="eRp_FD">
    <testProcedure id="funkt. Eignung: Test Produkt/FA"/>
  </actor>
