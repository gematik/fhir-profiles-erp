...
- KBV Medication (PZN) (aus dem [KBV_PR_ERP_Bundle](https://simplifier.net/erezept/kbv_pr_erp_bundle))
...
## Wichtige Punkte beim Mapping der PZN Medication Ressource

Die folgenden Punkte sind relevant für das Mapping der PZN Medication Ressource:
...
{% include StructureMap-KBVPrErpMedicationPznMap-intro.md %}
