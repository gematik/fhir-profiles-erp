...
> Quelle: [KBV Bundle](Bundle-example-1.html)
> Ziel: [EPA Provide Parameters](Bundle-example-1-parameters.html)
...
| `Bundle.identifier.value` | `Parameters.prescriptionId.valueIdentifier.value` | `160.100.000.000.037.28` |
...
| `MedicationRequest.id` | `MedicationRequest.id` | `43c2b7ae-ad11-4387-910a-e6b7a3c38d4f` |
...
| `MedicationRequest.medicationReference.reference` | `MedicationRequest.medicationReference.reference` | `Medication/5ff1bd22-ce14-484e-be56-d2ba4adeac31` |
