...
- KBV Medication (Freitext) (aus dem [KBV_PR_ERP_Bundle](https://simplifier.net/erezept/kbv_pr_erp_bundle))
...
## Wichtige Punkte beim Mapping der Freitext Medication Ressource

Die folgenden Punkte sind relevant für das Mapping der Freitext Medication Ressource:
